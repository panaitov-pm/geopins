...
const PinContent = ({ classes }) => {
  ...
  const {title, content, author, createdAt, comments} = mapInfo.currentPin;
  return (
      <div className={classes.root}>
        ...
        <Typography className={classes.text} component="h3" variant="subtitle2" color="inherit" gutterBottom>
